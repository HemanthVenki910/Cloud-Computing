...
#Url of API9
API9_URL = "http://52.207.157.87:80/api/v1/db/read"

# Response message 400
MESSAGE_400 = "Bad Request."

API_RIDES_CLEAR_DB="http://52.201.183.55:80/api/v1/db/clear"

API_RIDES_DELETE_RIDES="http://52.201.183.55:80/api/v1/db/write"
